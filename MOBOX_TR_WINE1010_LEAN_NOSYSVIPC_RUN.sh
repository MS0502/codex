...
STATUS="${DOWNLOADS}/MOBOX_TR_WINE1010_LEAN_NOSYSVIPC_STATUS.txt"
...
# Recent proot-distro enables PRoot's --sysvipc extension by default.
# On this device its helper re-exec path fails as:
#   error: expected absolute path: "--shm-helper"
# Disable only that generic PRoot extension for this A/B run.
...
STATUS=/mnt/downloads/MOBOX_TR_WINE1010_LEAN_NOSYSVIPC_STATUS.txt
...
export BOX64_DYNACACHE_FOLDER=/root/.cache/box64-tr-v4-wine1010-lean-nosysvipc
...
{
  echo "MOBOX TALESRUNNER WINE 10.10 LEAN NOSYSVIPC RUN"
  echo "================================================"
  date -Iseconds
