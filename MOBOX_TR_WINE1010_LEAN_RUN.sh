...
STATUS="${DOWNLOADS}/MOBOX_TR_WINE1010_LEAN_STATUS.txt"
...
STATUS=/mnt/downloads/MOBOX_TR_WINE1010_LEAN_STATUS.txt
...
export BOX64_DYNACACHE_FOLDER=/root/.cache/box64-tr-v4-wine1010-lean
...
{
  echo "MOBOX TALESRUNNER WINE 10.10 LEAN RUN"
  echo "======================================"
  date -Iseconds
